...
<body class="bg-gray-900 text-white mt-4">
    ...
    <!-- Navigation Bar -->
    <nav class="bg-white-400 p-4 flex justify-between items-center">
        ...
        <div class="space-x-4 hidden md:flex">
            ...
            <a href="{{ route('download.resume') }}" class="mt-0 inline-block bg-green-400 text-white py-1 px-3 rounded-lg hover:bg-green-500" download>Download Resume</a>
        </div>
    </nav>
